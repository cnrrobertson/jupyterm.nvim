...
function Jupyterm.setup(opts)
  ...
  -- Setup user commands
  vim.api.nvim_create_user_command("JupyStart", function(args) kernels.start_kernel(unpack(args.fargs)) end, {nargs="*"})
  vim.api.nvim_create_user_command("JupyShutdown", function(args) kernels.shutdown_kernel(unpack(args.fargs)) end, {nargs="?"})
  vim.api.nvim_create_user_command("JupyStatus", function(args) kernels.check_kernel_status(unpack(args.fargs)) end, {nargs="?"})
  vim.api.nvim_create_user_command("JupyInterrupt", function(args) kernels.interrupt_kernel(unpack(args.fargs)) end, {nargs="?"})
